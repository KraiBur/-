...
<head>
    ...
    <link rel="stylesheet" href="assets/css/stylesub.css">
</head>
<body>
...
<div class="cart">
                    <div class="photo__cart">
                        ...
                        <div class="text">
                            <div class="nazvanie">399 $ <br>
за месяц</div>
                            <div class="h__f">
                            Оплата ежемесячно
                            </div> <a href="https://www.tinkoff.ru/rm/buranbaeva.karina2/SmkdY95604" class="cta_btn">Оформить подписку</a>
                ...
                <div class="cart">
                    <div class="photo__cart">
                        ...
                        <div class="text">
                            <div class="nazvanie">299 $ <br>
за месяц</div>
                            <div class="h__f">
                            При оплате 899$ раз в 3 месяца
                            </div> <a href="https://www.tinkoff.ru/rm/buranbaeva.karina2/SmkdY95604" class="cta_btn">Оформить подписку</a>
                ...
                <div class="cart">
                    <div class="photo__cart">
                        ...
                        <div class="text">
                            <div class="nazvanie">199 $ <br>
за месяц</div>
                            <div class="h__f">
                            При оплате 2390$ раз в 12 месяца
                            </div> <a href="https://www.tinkoff.ru/rm/buranbaeva.karina2/SmkdY95604" class="cta_btn">Оформить подписку</a>
