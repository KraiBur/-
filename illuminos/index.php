...
?>
    ...
    <div class="category-wrap">
        ...
        <ul>
            ...
            <li><a href="h.php" class="underline-one"><img src="assets/img/solar_graph-down-new-broken.png" alt="">History</a></li>
        </ul>
...
<input class="lup" type="submit" name="submit">
        ...
        <div class="new__movies">
            ...
            <div class="zag__nm">New Movies</div>
            ...
            <div class="cont__movie">
                <div class="cart">
                    <div class="photo__cart">
                        ...
                        <div class="text">
                            <div class="nazvanie">John Wick : Chapter 4</div>
                            <div class="h__f">
        ...
        <div class="new__movies">
            ...
            <div class="zag__nm">Recommended</div>
